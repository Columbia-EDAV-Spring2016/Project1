...
setwd('/Users/dongchunfeng/GitHub/Project1')
library(rpart)
library(rpart.plot)
...
names(df_clean) [c(4,7:11)] <- c("r_data_modeling_experience","r_graphics_experience",
...
These two plots reflect the distributions of the proficiency of skills of students from different programs. Interestingly, Data Science Certifate students tend to report less proficiency of skills than other three groups in terms of median of the distribution.
...
This plot reflects the joint distributions of the proficiency of skills and the number of skills in different student groups. Contour lines represent density of this distribution. From this joint perspective we can see that the distributions of Data Science Certifate students and Data Science Masters(MS_DS) have larger density around "peak" than other two groups.
