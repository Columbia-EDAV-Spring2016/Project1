...
```{r, fig.align='center', fig.high=12, fig.width=8, warning=FALSE, echo=FALSE, message=FALSE}
# filter features
...
```{r, fig.align='center', fig.high=12, fig.width=8, echo=FALSE, warning = FALSE, message=FALSE}
...
```{r, echo=FALSE, warning = FALSE, message=FALSE, fig.align='center', fig.high=12, fig.width=12}
